...
public class ReceitaController {
	...
	@GetMapping
	public List<ReceitaDto> listarReceitas(@RequestParam(required = false, name = "descricao") String descricao) {

		List<Receita> receita;
		if (descricao == null) {
			receita = receitaRepository.findAll();
		} else {
	...
	@GetMapping("/{ano}/{mes}")
	public List<ReceitaDto> listarReceitasPorMes(@PathVariable(name = "ano") int ano,
			@PathVariable(name = "mes") int mes) {

		List<Receita> receita = receitaRepository.findByProcuraPorAnoMes(ano, mes);
