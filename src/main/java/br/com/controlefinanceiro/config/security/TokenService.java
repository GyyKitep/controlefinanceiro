package br.com.controlefinanceiro.config.security;
...
public class TokenService {
	...
	@Value("${controlefinanceiro.jwt.expiration}") //pega do properties
	private String expiration;
	
	@Value("${controlefinanceiro.jwt.secret}") //pega do properties
